...
func New(ctx context.Context, cfg Config) (*Registry, error) { //nolint:funlen,maintidx // Constructor wiring keeps ownership and reverse-order cleanup visible in one place.
	if cfg.Redis == nil {
