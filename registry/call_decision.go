...
//
//nolint:maintidx // One atomic attach transition validates all immutable identity and terminal outcomes.
...
//
//nolint:maintidx // One atomic ensure transition owns creation, replay, and conflict classification.
...
//
//nolint:funlen,maintidx // The Redis script result tuple is decoded in one exhaustive protocol boundary.
