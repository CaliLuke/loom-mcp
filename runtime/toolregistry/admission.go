...
const (
	...
	// MaxToolResultMessageBytes bounds one complete canonical terminal envelope
	// before the registry stores it in both the call record and result stream.
	MaxToolResultMessageBytes = 1024 * 1024
)
