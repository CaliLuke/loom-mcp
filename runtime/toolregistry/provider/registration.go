...
func (r Registration) normalizedWithJitter(jitter registrationJitter) (registrationConfig, error) { //nolint:maintidx // All lifecycle callbacks and timing invariants are validated together before side effects.
	if r.Register == nil {
...
//
//nolint:maintidx // One supervisor owns renewal, supersession, lease expiry, and shutdown ordering.
...
//
//nolint:maintidx // Registration retry keeps context, lease, and backoff outcomes in one loop.
