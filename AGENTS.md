...
- Use `.agents/skills/loom-compatibility-release/SKILL.md` before releasing a Loom change that may affect loom-mcp, or when sequencing Loom and loom-mcp releases together.
