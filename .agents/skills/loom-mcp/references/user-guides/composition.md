...
This guide demonstrates how to compose agents by treating one agent as a tool of another, and explains how loom-mcp models execution as a tree with streaming projections for different audiences.
...
loom-mcp models execution as a tree of runs and tools:
...
loom-mcp publishes client-facing stream.Event values into a single session-owned stream:
...
loom-mcp provides built-in profiles for common use cases:
