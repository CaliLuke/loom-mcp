...
| Compact tool discovery | Supported `search_tools`, `call_tool`, visible pins, and direct hidden calls. | Supports discovery, dispatch, and pins. It rejects the direct-hidden compatibility option. | Deliberate Loom extension. No consumer required direct hidden calls. |
