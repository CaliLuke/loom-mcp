...
import (
	...
	specs "example.com/assistant/progressive_discovery/gen/catalog/agents/owner/specs"
	projected2 "example.com/assistant/progressive_discovery/gen/catalog/toolsets/projected"
	"github.com/CaliLuke/loom-mcp/runtime/agent/engine"
	"github.com/CaliLuke/loom-mcp/runtime/agent/planner"
	agentsruntime "github.com/CaliLuke/loom-mcp/runtime/agent/runtime"
)

// RegisterOwnerAgent registers the generated agent components with the runtime.
func RegisterOwnerAgent(ctx context.Context, rt *agentsruntime.Runtime, cfg OwnerAgentConfig) error {
	if rt == nil {
		return errors.New("runtime is required")
	}
	agent, err := NewOwnerAgent(cfg)
	if err != nil {
		return err
	}
	if err := rt.RegisterAgent(ctx, agentsruntime.AgentRegistration{
		...
		Workflow: engine.WorkflowDefinition{
			Name:      "catalog.owner.workflow",
			TaskQueue: "catalog_owner_workflow",
			Handler:   rt.ExecuteWorkflow,
		},
		PlanActivityName: "catalog.owner.plan",
		PlanActivityOptions: engine.ActivityOptions{
			Queue:               "catalog_owner_workflow",
		...
		ResumeActivityName: "catalog.owner.resume",
...
func RegisterUsedToolsets(ctx context.Context, rt *agentsruntime.Runtime, opts ...func(map[string]agentsruntime.ToolCallExecutor)) error {
	...
	{
		const toolsetID = "catalog.projected"
...
// WithProjectedExecutor associates an executor for catalog.projected.
