...
type Client struct {
	...
	ResourcesListEndpoint        loom.Endpoint
	ResourcesReadEndpoint        loom.Endpoint
	ResourcesSubscribeEndpoint   loom.Endpoint
	ResourcesUnsubscribeEndpoint loom.Endpoint
	PromptsListEndpoint          loom.Endpoint
	PromptsGetEndpoint           loom.Endpoint
	NotifyStatusUpdateEndpoint   loom.Endpoint
...
func NewClient(initialize, ping, toolsList, toolsCall, toolsCallStream, resourcesList, resourcesRead, resourcesSubscribe, resourcesUnsubscribe, promptsList, promptsGet, notifyStatusUpdate, eventsStream, eventsStreamStream loom.Endpoint) *Client {
	return &Client{InitializeEndpoint: initialize, PingEndpoint: ping, ToolsListEndpoint: toolsList, ToolsCallEndpoint: toolsCall, ToolsCallStreamEndpoint: toolsCallStream, ResourcesListEndpoint: resourcesList, ResourcesReadEndpoint: resourcesRead, ResourcesSubscribeEndpoint: resourcesSubscribe, ResourcesUnsubscribeEndpoint: resourcesUnsubscribe, PromptsListEndpoint: promptsList, PromptsGetEndpoint: promptsGet, NotifyStatusUpdateEndpoint: notifyStatusUpdate, EventsStreamEndpoint: eventsStream, EventsStreamStreamEndpoint: eventsStreamStream}
}
