...
// NewConsumerConsumerLocalToolsetRegistration creates an in-process runtime registration backed by
// the adapter's progressive-discovery catalog and dispatch paths.
func NewConsumerConsumerLocalToolsetRegistration(adapter *MCPAdapter) (agentsruntime.ToolsetRegistration, error) {
	if adapter == nil {
