...
var (
	SpecAnswer = tools.ToolSpec{
		...
		Tags:        []string{},
		Payload:     tools.TypeSpec{Name: "AnswerPayload", Schema: []byte("{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"type\":\"object\",\"properties\":{\"question\":{\"type\":\"string\",\"description\":\"User question to answer\",\"example\":\"Labore natus exercitationem et omnis.\"}},\"required\":[\"question\"]}"), ExampleJSON: []byte("{\"question\":\"What is the capital of Japan?\"}"), ExampleInput: map[string]any{"question": "What is the capital of Japan?"}, Codec: answerPayloadCodec},
		Result:      tools.TypeSpec{Name: "AnswerResult", Schema: []byte("{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"type\":\"object\",\"properties\":{\"text\":{\"type\":\"string\",\"description\":\"Answer text\",\"example\":\"Dolor ea vel quia vero quo.\"}},\"required\":[\"text\"]}"), Codec: answerResultCodec},
	}
)
